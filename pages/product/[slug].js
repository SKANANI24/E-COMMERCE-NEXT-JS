                ...
                <div className="flex">
                  ...
                  {Object.keys(variants).includes("White") &&
                    Object.keys(variants["White"]).includes(size) && (
                      <button onClick={()=>{refreshVariant( size , 'White')}} className={`border-2 border-gray-300 ml-1 bg-white-500 rounded-full w-6 h-6 focus:outline-none ${color==='White' ? `border-black` : `border-grey-300`}`}></button>

                    )}
                  {Object.keys(variants).includes("Red") &&
                    Object.keys(variants["Red"]) && (
                      <button onClick={()=>{refreshVariant( size , 'Red')}} className={`border-2 border-gray-300 ml-1 bg-red-500 rounded-full w-6 h-6 focus:outline-none ${color==='Red' ? `border-black` : `border-grey-300`}`}></button>
                    )}
                  {Object.keys(variants).includes("Blue") &&
                
                    Object.keys(variants["Blue"]).includes(size) && (
                      <button onClick={()=>{refreshVariant( size , 'Blue')}} className={`border-2 border-gray-300 ml-1 bg-blue-500 rounded-full w-6 h-6 focus:outline-none ${color==='Blue' ? `border-black` : `border-grey-300`}`}></button>
                    )}
                    {Object.keys(variants).includes("Yellow") &&
                    Object.keys(variants["Yellow"]).includes(size) && (
                      <button onClick={()=>{refreshVariant( size , 'Yellow')}} className={`border-2 border-gray-300 ml-1 bg-yellow-500 rounded-full w-6 h-6 focus:outline-none ${color==='Yellow' ? `border-black` : `border-grey-300`}`}></button>
                    )}
                  {Object.keys(variants).includes("Black") &&
                    Object.keys(variants["Black"]).includes(size) && (
                      <button onClick={()=>{refreshVariant( size , 'Black')}} className={`border-2 border-gray-300 ml-1 bg-black-500 rounded-full w-6 h-6 focus:outline-none ${color==='Black' ? `border-black` : `border-grey-300`}`}></button>
                    )}
                </div>
